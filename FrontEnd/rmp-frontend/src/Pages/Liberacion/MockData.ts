...
export const MOCK_LOTES_PENDIENTES: LotePendienteDto[] = [
  {
    id: "lote-001",
  ...
  {
    id: "lote-003",
    numeroLoteInterno: "L-2026-0044-01",
    itemId: "item-006",
    itemNombre: "Azúcar refinada",
    itemCodigo: "SEC-001",
    categoriaNombre: "Secos",
    requiereCadenaFrio: false,
    recepcionId: "rec-005",
    numeroRecepcion: "REC-2026-0044",
  ...
  {
    id: "lote-004",
    numeroLoteInterno: "L-2026-0044-02",
    itemId: "item-007",
  ...
  {
    id: "lote-005",
    numeroLoteInterno: "L-2026-0047-01",
    itemId: "item-003",
    itemNombre: "Leche entera UHT",
    itemCodigo: "LAC-001",
