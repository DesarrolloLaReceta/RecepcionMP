...
public sealed class LoteRecibidoConfiguration : IEntityTypeConfiguration<LoteRecibido>
{
    public void Configure(EntityTypeBuilder<LoteRecibido> builder)
    {
        ...
        builder.Property(l => l.NumeroLoteProveedor)
            .HasMaxLength(100);

        builder.Property(l => l.CodigoLoteInterno)
            .IsRequired()
            .HasMaxLength(50);

        builder.Property(l => l.CodigoQr)
            .HasMaxLength(500);
        ...
        builder.Property(l => l.CantidadRechazada)
            .IsRequired()
            .HasColumnType("decimal(12,3)")
            .HasDefaultValue(0);
        ...
        builder.Property(l => l.TemperaturaMedida)
            .HasColumnType("decimal(5,2)");

        builder.Property(l => l.EstadoSensorial)
            .IsRequired()
            .HasConversion<string>()
            .HasMaxLength(50);

        builder.Property(l => l.EstadoRotulado)
            .IsRequired()
            .HasConversion<string>()
            .HasMaxLength(50);
        ...
        builder.Property(l => l.UbicacionDestino)
            .HasConversion<string>()
            .HasMaxLength(50);
        ...
        // Value Object VidaUtil — persiste FechaVencimiento y FechaFabricacion
        // DiasRestantes es calculado, no se persiste
        builder.OwnsOne(l => l.VidaUtil, vu =>
        {
            vu.Property(v => v.FechaVencimiento)
        ...
        builder.HasOne(l => l.DetalleOrdenCompra)
            .WithMany()
            .HasForeignKey(l => l.DetalleOcId)
            .OnDelete(DeleteBehavior.Restrict);
