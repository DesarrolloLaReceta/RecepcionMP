...
namespace SistemaRecepcionMP.Infraestructure.Migrations
{
    ...
    [Migration("20260512180000_AddVerificacionInstalacionResponsableYMes")]
    partial class AddVerificacionInstalacionResponsableYMes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SistemaRecepcionMP.Domain.Entities.DetalleInspeccionCocina", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("LiberacionCocinaId")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("LiberacionCocinaId");

                    b.ToTable("DetallesInspeccionCocinas");
                });
            ...
            modelBuilder.Entity("SistemaRecepcionMP.Domain.Entities.LiberacionCocina", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SistemaRecepcionMP.Domain.Entities.RecepcionNovedad", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("DetectadaPorUserId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("DetectadaPorUserId");

                    b.HasIndex("RecepcionId");

                    b.ToTable("RecepcionesNovedad", (string)null);
                });

            modelBuilder.Entity("SistemaRecepcionMP.Domain.Entities.RecepcionNovedadDetalle", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<decimal>("CantidadSiesa")
                        .HasPrecision(18, 4)
                        .HasColumnType("decimal(18,4)");
                    ...
                    b.Property<Guid>("RecepcionNovedadId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("RecepcionNovedadId");

                    b.ToTable("RecepcionesNovedadDetalle", (string)null);
                });

            modelBuilder.Entity("SistemaRecepcionMP.Domain.Entities.RecepcionNovedadNotificacion", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("RecepcionesNovedadNotificacion", (string)null);
                });
            ...
            modelBuilder.Entity("SistemaRecepcionMP.Domain.Entities.VerificacionInstalacion", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<decimal>("CumplimientoTotal")
                        .HasPrecision(5, 2)
                        .HasColumnType("decimal(5,2)");
                    ...
                    b.ToTable("VerificacionesInstalaciones", (string)null);
                });

            modelBuilder.Entity("SistemaRecepcionMP.Domain.Entities.VerificacionInstalacionDetalle", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<string>("AspectoId")
                        .IsRequired()
                        .HasMaxLength(80)
                        .HasColumnType("nvarchar(80)");

                    b.Property<string>("AspectoNombre")
                        .IsRequired()
                        .HasMaxLength(250)
                        .HasColumnType("nvarchar(250)");
                    ...
                    b.Property<Guid>("VerificacionInstalacionId")
                        .HasColumnType("uniqueidentifier");

                    b.HasKey("Id");

                    b.HasIndex("VerificacionInstalacionId");

                    b.ToTable("VerificacionesInstalacionesDetalle", (string)null);
                });
            ...
            modelBuilder.Entity("SistemaRecepcionMP.Domain.Entities.DetalleInspeccionCocina", b =>
                {
                    b.HasOne("SistemaRecepcionMP.Domain.Entities.LiberacionCocina", null)
                        .WithMany("Detalles")
                        .HasForeignKey("LiberacionCocinaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("SistemaRecepcionMP.Domain.Entities.RecepcionNovedad", b =>
                {
                    b.HasOne("SistemaRecepcionMP.Domain.Entities.Usuario", "DetectadaPor")
                        .WithMany()
                        .HasForeignKey("DetectadaPorUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("SistemaRecepcionMP.Domain.Entities.RecepcionNovedadDetalle", b =>
                {
                    ...
                    b.HasOne("SistemaRecepcionMP.Domain.Entities.RecepcionNovedad", "RecepcionNovedad")
                        .WithMany("Detalles")
                        .HasForeignKey("RecepcionNovedadId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("SistemaRecepcionMP.Domain.Entities.VerificacionInstalacionDetalle", b =>
                {
                    b.HasOne("SistemaRecepcionMP.Domain.Entities.VerificacionInstalacion", "VerificacionInstalacion")
                        .WithMany("Detalles")
                        .HasForeignKey("VerificacionInstalacionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("VerificacionInstalacion");
                });
